 ...
 * @author asus
 */
public class International_database extends javax.swing.JFrame {

    /**
     * Creates new form HomePage
     */
    public International_database() {
        initComponents();
        try {
    ...
    private void initComponents() {
        ...
        jLabel3.setText("International SHIPPING DATABASE");
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addComponent(SEARCH1, javax.swing.GroupLayout.PREFERRED_SIZE, 156, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addComponent(search)
    ...
    private void updateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updateActionPerformed
        ...
        try {
            ...
            if (jCheckBox1.isSelected()) {
                String sql = "UPDATE INTERNATIONAL SET DELIVERED = true WHERE SENDERNAME = '" + SenderName.getText() + "'";
                st = con.createStatement();
                row = st.executeUpdate(sql);
                JOptionPane.showMessageDialog(null, "DELIVERY STATUS RESET", "Info", JOptionPane.INFORMATION_MESSAGE);
            } else {
                String sql = "UPDATE INTERNATIONAL SET DELIVERED = false WHERE SENDERNAME = '" + SenderName.getText() + "'";
                st = con.createStatement();
                row = st.executeUpdate(sql);
                JOptionPane.showMessageDialog(null, "DELIVERY STATUS RESET", "Info", JOptionPane.INFORMATION_MESSAGE);
            }
    ...
    private void DeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_DeleteActionPerformed
        ...
        try {
            if (SenderName.getText().isEmpty()) {
                ...
                String sql = "DELETE FROM INTERNATIONAL WHERE SENDERNAME = '" + SenderName.getText() + "'";
                st = con.createStatement();
                row = st.executeUpdate(sql);
    ...
    private void SEARCH1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SEARCH1ActionPerformed
        ...
        int row = -1;
        try {
            String sql = "SELECT * FROM  INTERNATIONAL WHERE SENDERNAME = '" + search.getText() + "'";
            st = con.createStatement();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(International_database.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    public void showAll() {
        try {
            String sql = "SELECT * FROM INTERNATIONAL ";
            st = con.createStatement();
            rs = st.executeQuery(sql);
